...
analyze_info = {
    "dcc_file": r"E:\Work\Scene\Clarisse\s02c01A.lgt_set.project", # DCC 文件路径
    "dcc_version": "5.0 SP11", # DCC 版本号
...
param_check_obj.set_render_layers({
    "project://render/cam2.color_sun_chr": "19781-24779",
    "project://render/cam2.ID_chr": "19781-24779"
})
